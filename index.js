...
const UUID = process.env.UUID || '0ba6ab2f-bc5c-4355-a408-18003c62cefc'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'sypflm';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'hf';                       // 节点名称
